...
axios.get('https://api.github.com/users/dmnqgrrtt')
.then(response => {
...
const gitCard = (gitData) => {
  ...
  webAddress.href = gitData.html_url;
  webAddress.textContent = gitData.html_url;
  profile.insertAdjacentHTML('afterbegin', 'Profile: ')
